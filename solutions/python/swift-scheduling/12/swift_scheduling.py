...
def _handle_n_quarter_description(start_dt: datetime, description: str) -> datetime:
    ...
    return datetime(year, delivery_quarter * 3, last_workday, 8, 0, 0)
...
def _handle_n_month_description(start_dt: datetime, description: str) -> datetime:
    ...
    return datetime(year, delivery_month, first_workday, 8, 0, 0)
...
def _handle_end_of_week_delivery(start_dt: datetime) -> datetime:
    ...
    return datetime(delivery_day_dt.year, delivery_day_dt.month, delivery_day_dt.day, attributes["hour"], 0, 0)