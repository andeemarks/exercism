defmodule MatchingBrackets do
  ...
  def check_brackets(str) do
    clean_str = str |> String.replace(~r/[^{}\[\]\(\)]/, "")
            ...
            if opening_brace_only? do
              ...
              if opening_paren_only? do
                ...
                if unmatched? do
                  ...
                  opening_only = clean_str_no_inner |> String.replace(~r/[^\[\{\(]/, "")
                  closing_only = clean_str_no_inner |> String.replace(~r/[^\]\}\)]/, "")
                  foo = closing_only
                  |> String.reverse()
                  |> String.replace("}", "{")
                  |> String.replace("]", "[")
  ...
  def check_balance("[", "]"), do: true
  def check_balance("{", "}"), do: true
  def check_balance("(", ")"), do: true
  def check_balance(_, _), do: false
end
