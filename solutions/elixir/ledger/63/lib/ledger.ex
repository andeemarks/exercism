defmodule Ledger do
  ...
  def format_entries(currency, locale, entries) do
    Ledger.Locale.settings(locale)[:header] <> Ledger.Entry.format(entries, currency, locale)
  end

  defmodule EntryDate do
    def format(locale, entry_date, formatter) do
  ...
  defmodule Entry do
    ...
    defp format_entry(entry, currency, locale) do
      date = Ledger.EntryDate.format(locale, entry.date, Ledger.Locale.settings(locale).format_date)
