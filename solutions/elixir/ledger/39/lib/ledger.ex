defmodule Ledger do
  ...
  defmodule EntryDate do
    ...
    defp format(:en_US, day, month, year) do
      month <> "/" <> day <> "/" <> year <> " "
    end
    defp format(_, day, month, year) do
      day <> "-" <> month <> "-" <> year <> " "
    end
  ...
  defmodule Entry do
    ...
    defp format_number(entry_amount_in_cents, :en_US), do:  format_number(entry_amount_in_cents, ",", ".")
    defp format_number(entry_amount_in_cents, _), do:       format_number(entry_amount_in_cents, ".", ",")
    defp format_number(entry_amount_in_cents, thousands_separator, cents_separator) do
      format_whole(entry_amount_in_cents, thousands_separator) <> cents_separator <> format_decimal(entry_amount_in_cents)
    end
