defmodule Ledger do
  ...
  defmodule Entry do
    @currency_settings %{ usd: %{symbol: "$"}, eur: %{symbol: "€"}}
    @locale_settings %{ en_US: %{thousands_separator: ",", cents_separator: "."}, nl_NL: %{thousands_separator: ".", cents_separator: ","}}
    ...
    defp format_entry(entry, currency, locale) do
      ...
      symbol = @currency_settings[currency][:symbol]
      locale_settings = Ledger.LocalSettings.get(locale)
