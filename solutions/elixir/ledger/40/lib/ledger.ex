defmodule Ledger do
  ...
  defmodule Entry do
    ...
    defp format_cents(entry_amount_in_cents, :en_US), do:  format_cents(entry_amount_in_cents, ",", ".")
    defp format_cents(entry_amount_in_cents, _), do:       format_cents(entry_amount_in_cents, ".", ",")
    defp format_cents(entry_amount_in_cents, thousands_separator, cents_separator) do
