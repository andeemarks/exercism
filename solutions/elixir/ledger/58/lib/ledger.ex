defmodule Ledger do
  ...
  def format_entries(currency, locale, entries) do
    locale_settings = Ledger.LocalSettings.get(locale)

    locale_settings[:header] <> Ledger.Entry.format(entries, currency, locale)
  end

  defmodule LocalSettings do
    @locale_settings %{ en_US:
                        ...
                        nl_NL:
                          ...
                          date_separator: "-",
                          cents_separator: ","}}
    def get(locale), do: @locale_settings[locale]
  end
  ...
  defmodule EntryDate do
    def format(locale, entry_date) do
      ...
      date_separator = Ledger.LocalSettings.get(locale)[:date_separator]
