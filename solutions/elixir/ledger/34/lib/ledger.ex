defmodule Ledger do
  ...
  def format_entries(currency, locale, entries) do
    header = Ledger.Header.format(locale)

    Ledger.Entry.format(entries, header, currency, locale)
  ...
  defmodule Entry do
    def format([], header, _currency, _locale), do: header
    def format(entries, header, currency, locale) do
        entries =
