defmodule LinkedList do
  ...
  def tail(list) when is_tuple(list), do: tail(Tuple.to_list(list))
  def tail([_|t]), do: {:ok, List.to_tuple(t)}
  ...
  def pop(list) when is_tuple(list), do: pop(Tuple.to_list(list))
  def pop([h|t]), do: {:ok, h, List.to_tuple(t)}
