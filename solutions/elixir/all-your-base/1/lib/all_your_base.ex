defmodule AllYourBase do
  ...
  def to_base_10(digits, input_base) do
    digits
    |> Enum.reverse()
    |> Enum.with_index()
  ...
  def base_10_to_output_base(0, _), do: [0]
  def base_10_to_output_base(digits, 10), do: Integer.digits(digits)
  def base_10_to_output_base(digits, 16) do
    digits
    |> Integer.to_string(16)
    |> String.graphemes()
    |> Enum.map(fn d -> Integer.parse(d, 16) |> elem(0) end)
  end

  def base_10_to_output_base(digits, output_base) when output_base >= 2 and output_base <= 36 do
    digits
  ...
  def base_10_to_output_base(digits, output_base) do
    powers = 0..100
  ...
  def do_base_10_to_output_base(digits, powers) do
    case powers do
      [] -> []
      [power | rest] ->
