...
public static class Wordy
{
    public static int Answer(string question)
    {
        ...
        try
        {
            ...
            {
                var result = ResolveTwoOperandEquation(twoOperandTest);
