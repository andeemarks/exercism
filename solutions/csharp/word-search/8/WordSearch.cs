...
public class WordSearch
{
    ...
    private void FindWordInDiagonals(Dictionary<string, ((int, int), (int, int))?> finds, string word)
    {
        ...
        FindWordInDiagonalsB2TR2L(finds, word, B2TR2LCoordMapper);
        FindWordInDiagonalsB2TL2R(finds, word, B2TL2RCoordMapper);
    ...
    private void FindWordInDiagonalsB2TR2L(Dictionary<string, ((int, int), (int, int))?> finds, string word, Func<int, int, int, ((int, int), (int, int))> mapper)
    {
    ...
    private void FindWordInDiagonalsB2TL2R(Dictionary<string, ((int, int), (int, int))?> finds, string word, Func<int, int, int, ((int, int), (int, int))> mapper)
    {
        var reversedWord = ReverseWord(word);
