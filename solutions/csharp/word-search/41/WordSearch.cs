...
public class WordSearch(string grid)
{
    ...
    class CoordMapping
    {
        ...
        public static CoordPair B2T(int lineNumber, int wordStart, int wordLength) => ((lineNumber, wordStart + wordLength), (lineNumber, wordStart + 1));
        public static CoordPair T2B(int lineNumber, int wordStart, int wordLength) => ((lineNumber, wordStart + 1), (lineNumber, wordStart + wordLength));
        public static CoordPair L2R(int lineNumber, int wordStart, int wordLength) => ((wordStart + 1, lineNumber), (wordStart + wordLength, lineNumber));
        public static CoordPair R2L(int lineNumber, int wordStart, int wordLength) => ((wordStart + wordLength, lineNumber), (wordStart + 1, lineNumber));
    }
}
