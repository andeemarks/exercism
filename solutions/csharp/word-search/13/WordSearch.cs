...
public class WordSearch
{
    ...
    private void FindWordInDiagonalsT2BL2R(Dictionary<string, ((int, int), (int, int))?> finds, string word, Func<int, int, int, ((int, int), (int, int))> mapper)
    {
        var lines = grid.Split();
    ...
    private void FindWordInDiagonalsT2BR2L(Dictionary<string, ((int, int), (int, int))?> finds, string word, Func<int, int, int, ((int, int), (int, int))> mapper)
{
    var lines = grid.Split();
    var allLetters = grid.Replace("\n", "");
    var lineLength = lines[0].Length;
