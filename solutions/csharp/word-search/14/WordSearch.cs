...
public class WordSearch
{
    ...
    {
        FindWordInDiagonalsT2BL2R(finds, word, 1, T2BL2RMapper);
        FindWordInDiagonalsB2T(finds, word, 1, B2TR2LCoordMapper);
        FindWordInDiagonalsB2T(finds, word, -1, B2TL2RCoordMapper);
        FindWordInDiagonalsT2BR2L(finds, word, -1, T2BR2LMapper);
    }
    ...
    private void FindWordInDiagonalsT2BL2R(Dictionary<string, ((int, int), (int, int))?> finds, string word, int offset, Func<int, int, int, ((int, int), (int, int))> mapper)
    {
        var lines = grid.Split();
    ...
    private void FindWordInDiagonalsT2BR2L(Dictionary<string, ((int, int), (int, int))?> finds, string word, int offset, Func<int, int, int, ((int, int), (int, int))> mapper)
{
    var lines = grid.Split();
    var allLetters = grid.Replace("\n", "");
    var lineLength = lines[0].Length;
    ...
    private void FindWordInDiagonalsB2T(Dictionary<string, ((int, int), (int, int))?> finds, string word, int offset, Func<int, int, int, ((int, int), (int, int))> mapper)
    {
