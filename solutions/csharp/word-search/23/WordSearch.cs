...
public class WordSearch(string grid)
{
    ...
    private void FindWordInDiagonals(Dictionary<string, CoordPair?> results, string word, string label, int offset, Func<int, int, int, ((int, int), (int, int))> mapper)
    {
        var lines = grid.Split();
    ...
    private static void FindWordInColumns(Dictionary<string, CoordPair?> results, string word, string[] lines)
    {
        var lineNumber = 1;
    ...
    private static void FindWordB2T(Dictionary<string, CoordPair?> results, string word, int lineNumber, string rowLine)
    {
        var reversedWord = ReverseWord(word);
