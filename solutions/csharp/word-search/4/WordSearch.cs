...
public class WordSearch
{
    ...
    private void FindWordInDiagonals(Dictionary<string, ((int, int), (int, int))?> finds, string word)
    {
        ...
        FindWordInDiagonalsB2TR2L(finds, word);
    ...
    private void FindWordInDiagonalsB2TR2L(Dictionary<string, ((int, int), (int, int))?> finds, string word)
    {
        var target = ReverseWord(word);
