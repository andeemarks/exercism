...
public class BowlingGame
{
    ...
    public int? Score()
    {
        ...
        ValidateFrame11Completion(previousFrame);
        ValidateFrame12Completion(previousFrame);
        ValidateOpenFrame(previousFrame);

        return frames.Sum(frame => frame.Score());
    }

    private void ValidateFrame11Completion(Frame? previousFrame)
    {
    ...
    private void ValidateFrame12Completion(Frame? previousFrame)
    {
    ...
    private void ValidateOpenFrame(Frame? previousFrame)
    {
