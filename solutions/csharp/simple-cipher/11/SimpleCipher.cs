...
public class SimpleCipher
{
    ...
    private static char EncodeCharBy(char textChar, char keyChar) => (char)((textChar - 'a' + keyChar - 'a') % 26 + 'a');
    private static char DecodeCharBy(char textChar, char keyChar) => (char)((textChar - 'a' - keyChar + 'a' + 26) % 26 + 'a');
