...
public static class Diamond
{
    ...
    private static readonly string LETTERS_REVERSED = new([.. LETTERS.ToCharArray().Reverse()]);
    private static readonly string FULL_ROW = LETTERS_REVERSED + LETTERS[1..];
    ...
    private static string[] BuildTopHalf(int targetPos)
    {
        ...
        var row = FULL_ROW.Substring(LETTERS.Length - targetPos, rowWidth);
