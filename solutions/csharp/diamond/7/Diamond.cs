...
public static class Diamond
{
    public static string Make(char target)
    {
        ...
        var topHalf = BuildTopHalf(finalLetterPos, letters);
    ...
    private static string[] BuildTopHalf(int targetPos, string letters)
    {
        ...
        {
            var otherLetters = @"[^" + letters[i] + "]";
            topHalf[i] = Regex.Replace(fullRow, otherLetters, " ").Substring(letters.Length - targetPos, rowWidth);
        }
