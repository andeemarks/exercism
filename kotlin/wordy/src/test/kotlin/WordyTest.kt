...
class WordyTest {
    ...
    @Test fun `just a number`() = assertEquals(5, Wordy.answer("What is 5?"))

    @Test fun addition() = assertEquals(2, Wordy.answer("What is 1 plus 1?"))

    @Test fun `more addition`() = assertEquals(55, Wordy.answer("What is 53 plus 2?"))

    @Test
    fun `addition with negative numbers`() = assertEquals(-11, Wordy.answer("What is -1 plus -10?"))

    @Test fun `large addition`() = assertEquals(45801, Wordy.answer("What is 123 plus 45678?"))

    @Test fun subtraction() = assertEquals(16, Wordy.answer("What is 4 minus -12?"))

    @Test fun multiplication() = assertEquals(-75, Wordy.answer("What is -3 multiplied by 25?"))

    @Test fun division() = assertEquals(-11, Wordy.answer("What is 33 divided by -3?"))

    @Test fun `multiple additions`() = assertEquals(3, Wordy.answer("What is 1 plus 1 plus 1?"))
    ...
    @Test
    fun `multiple multiplication`() =
            assertEquals(-12, Wordy.answer("What is 2 multiplied by -2 multiplied by 3?"))

    @Test
    fun `addition and multiplication`() =
            assertEquals(-8, Wordy.answer("What is -3 plus 7 multiplied by -2?"))

    @Test
    fun `multiple division`() =
            assertEquals(2, Wordy.answer("What is -12 divided by 2 divided by -3?"))
    ...
    // Bonus Question
    @Test fun power() = assertEquals(32, Wordy.answer("What is 2 raised to the 5th power?"))
