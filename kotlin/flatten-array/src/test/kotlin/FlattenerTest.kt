...
class FlattenerTest {
    ...
    fun flattens5LevelNestedList() {
        val nestedList =
                listOf(0, 2, listOf(listOf(2, 3), 8, 100, 4, listOf(listOf(listOf(50))), -2))
    ...
    fun flattens6LevelNestedList() {
        val nestedList =
                listOf(1, listOf(2, listOf(listOf(3)), listOf(4, listOf(listOf(5))), 6, 7), 8)
        assertEquals(listOf(1, 2, 3, 4, 5, 6, 7, 8), Flattener.flatten(nestedList))
    }
    ...
    fun flattens6LevelNestedListWithNulls() {
        val nestedList =
                listOf(
                        0,
                        2,
                        listOf(listOf(2, 3), 8, listOf(listOf(100)), null, listOf(listOf(null))),
                        -2)
